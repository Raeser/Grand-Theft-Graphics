...
void CWwiseManager::SetPosition(float aX, float aY, float aZ, int aObjectID, float aDirectionX, float aDirectionY, float aDirectionZ)
{
	...
	soundPos.Orientation.X = aDirectionX;
	soundPos.Orientation.Y = aDirectionY;
	soundPos.Orientation.Z = aDirectionZ;
	AKRESULT result = AK::SoundEngine::SetPosition(aObjectID, soundPos);

	result;
}

void CWwiseManager::SetListenerPosition(float aX, float aY, float aZ, float aDirectionX, float aDirectionY, float aDirectionZ, float aUpX, float aUpY, float aUpZ)
{
	...
	soundPos.OrientationFront.X = aDirectionX;
	soundPos.OrientationFront.Y = aDirectionY;
	soundPos.OrientationFront.Z = aDirectionZ;
