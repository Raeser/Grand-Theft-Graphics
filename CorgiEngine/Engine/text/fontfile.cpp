...
#define STRINGTOINT( stringToChange ) atoi(stringToChange.c_str());
#pragma optimize( "", on ) 
...
bool ParseFontFile(Corgi::GrowingArray<fontChar> &fontChars, std::string &fontfilename, uint texwidth, uint texheight)
{
